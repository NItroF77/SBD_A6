...
ALTER TABLE akun ADD CONSTRAINT akun_pk PRIMARY KEY ( userid );
...
CREATE TABLE mesin (
    ...
    status_peminjam  CHAR(1 CHAR) NOT NULL
);
...
ALTER TABLE penulis ADD CONSTRAINT penulis_pk PRIMARY KEY ( nama );

CREATE TABLE "penulis-buku" (
    buku_nama_buku  VARCHAR2(30 CHAR) NOT NULL,
    penulis_nama    VARCHAR2(30 CHAR) NOT NULL
);
...
CREATE TABLE stok_buku (
    ...
    status_peminjaman  CHAR(1 CHAR) NOT NULL,
...
ALTER TABLE "penulis-buku"
    ADD CONSTRAINT "penulis-buku_Buku_FK" FOREIGN KEY ( buku_nama_buku )
        REFERENCES buku ( nama_buku );

ALTER TABLE "penulis-buku"
    ADD CONSTRAINT "penulis-buku_Penulis_FK" FOREIGN KEY ( penulis_nama )
